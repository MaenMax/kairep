...
// An Alternative Base 64 encoding scheme thus ABase64.
// The difference with this encoding and the original Base64 
// is that the generated encoded string will keep the same 
// order as the original binary data, i.e. ordering encoded 
// values will provide the same result as having ordered the
// original binary value. 
//
// The application is for key generation (uuid and fuuid).
...
const encodeStd = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz"
...
// We currently only support one encoding scheme.
var StdEncoding = NewEncoding(encodeStd)

// RawStdEncoding is the standard raw, unpadded abase64 encoding.
